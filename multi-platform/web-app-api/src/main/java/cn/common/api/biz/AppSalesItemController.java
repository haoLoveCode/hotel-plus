...
@Slf4j
public class AppSalesItemController extends BaseApiController {

    @Resource
    private AppSalesItemService appSalesItemService;
    ...
    public ApiResponse addItem(@RequestBody @Valid SalesItemAddReq addReq){
        appSalesItemService.addItem(addReq);
        return apiResponse();
    }
    ...
    public ApiResponse batchDeleteItem(@RequestBody BaseDeleteReq req){
        appSalesItemService.batchDeleteItem(req);
        return apiResponse();
    }
    ...
    public ApiResponse updateItem(@RequestBody @Valid SalesItemUpdateReq updateReq){
        appSalesItemService.updateItem(updateReq);
        return apiResponse();
    }
    ...
    public ApiResponse<List<SalesItemResp>> querySalesItem(
        ...
        return apiResponse(appSalesItemService.querySalesItem(req));
    }
    ...
    public ApiResponse<SalesItemResp> queryOneSalesItem(
        @RequestBody @Valid SalesItemReq req){
        return apiResponse(appSalesItemService.queryOneSalesItem(req));
    }
    ...
    public ApiResponse<Pagination<SalesItemResp>> queryByPage(
        ...
        return apiResponse(appSalesItemService.queryByPage(pageReq));
    }
}
