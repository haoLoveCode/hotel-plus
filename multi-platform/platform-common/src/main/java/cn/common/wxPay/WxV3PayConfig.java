...
public class WxV3PayConfig {
     ...
     */
    @Bean("refundService")
    public RefundService initWxRefundService(){
        ...
        try {
            ...
            privateKey = privateKey.replace("-----BEGIN PRIVATE KEY-----", "")
                    ...
                    .replaceAll("\\s+", "");
            redisRepository.set(privateKeyRedisKey,privateKey);
     ...
     * @return com.wechat.pay.java.service.payments.jsapi.JsapiService
     */
    @Bean("transferBatchService")
    public TransferBatchService initTransferBatchService(){
