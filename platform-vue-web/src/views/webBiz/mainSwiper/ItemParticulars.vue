        ...
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            ...
            <div class="descriptions-value">
              {{ particularsData.mainTitle }}
            </div>
          </div>
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">跳转地址:</el-tag>
            </div>
            <div class="descriptions-value">
              {{ particularsData.routerUrl }}
            </div>
          </div>
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">关联项:</el-tag>
            </div>
            <div class="descriptions-value">
              {{ particularsData.itemId }}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            ...
            <div class="descriptions-value">
              <img @click="handlePreView(handleImageUrl(particularsData.mainUrl))"
                   :src="handleImageUrl(particularsData.mainUrl)"
