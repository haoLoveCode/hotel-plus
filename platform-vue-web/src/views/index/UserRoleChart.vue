<template>
    <div class="page-view">
        <div id="chartSearchDiv" class="chart-search-div" style="height: 130px">
            <div class="chart-text-view">系统人员角色分布</div>
        ...
        <div class="chart-view">
          <div id="UserRoleChartContainer" class="chart-item">
          </div>
        </div>
    </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      async initChart() {
        ...
        console.log('初始化表格')
        let chart = new Chart({
          container: 'UserRoleChartContainer',
          autoFit: true,
          height: 300,
          width:300
        });
        ...
        const interval = chart
            ...
            .adjust('stack')
            .position('countNum')
            .color('roleName', ['#063d8a', '#1770d6', '#47abfc', '#38c060'])
            .style({ opacity: 0.4 })
            .state({
              active: {
                style: (element) => {
