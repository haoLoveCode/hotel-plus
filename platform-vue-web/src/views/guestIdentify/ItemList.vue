      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          <div class="search-item-view">
            <el-form-item label="客户身份信息">
              <el-select
                  ...
                  :clearable="true"
                  @change="handleGuestIdentifyChange"
                  placeholder="请选择客户身份信息">
                <el-option
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('guestIdentify:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('guestIdentify:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('guestIdentify:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('guestIdentify:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('guestIdentify:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('guestIdentify:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleGuestIdentifyChange(value) {
        this.searchData.guestIdentifyId = value
      },
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.guestIdentifyId)
        this.deleteButtonLoading = true
        Api.batchDeleteGuestIdentify({
      ...
      batchDelete() {
        ...
        multipleSelection.map(item => {
          mainIdList.push(item.guestIdentifyId)
        })
