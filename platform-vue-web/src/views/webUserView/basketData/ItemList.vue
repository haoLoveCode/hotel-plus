<template>
  <div class="page-view">
      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          <div class="search-view">
            ...
            <div class="search-item-view">
              <el-form-item label="商品信息">
                <el-select
                    v-model="searchData.salesItemId"
                    :clearable="true"
                    placeholder="请选择商品信息">
                  <el-option
                      v-for="(item,index) in authAppUserOptions"
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('basketData:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('basketData:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('basketData:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
    ...
    >
      ...
      >
        <template v-slot="scope">
          {{handleTypeByValue(scope.row.salesItemId,salesItemOptions)}}
        </template>
      </el-table-column>
      <el-table-column
        prop="remarkData"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('basketData:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('basketData:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('basketData:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleBasketDataChange(value) {
        this.searchData.basketDataId = value
      },
      async queryBasketData() {
        const loading = this.$loading({
          lock: true,
          text: "正在请求。。。",
          spinner: 'el-icon-loading',
        ...
        try {
          Api.queryBasketData({}).then((res) => {
            if (res.success) {
              ...
              this.basketDataOptions = new Array();
              data.map((item) => {
                let options = {
                  'text': item.basketDataName,
                  'value': item.basketDataId
                }
                this.basketDataOptions.push(options)
              })
              console.log('this.basketDataOptions:' + JSON.stringify(this.basketDataOptions))
              loading.close();
            } else {
              loading.close();
              this.$message.error('服务器异常');
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.basketDataId)
        this.deleteButtonLoading = true
        Api.batchDeleteBasketData({
      ...
      batchDelete() {
        ...
        multipleSelection.map(item => {
          mainIdList.push(item.basketDataId)
        })
