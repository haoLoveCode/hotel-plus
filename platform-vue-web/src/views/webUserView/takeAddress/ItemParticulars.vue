    ...
    <div class="particulars-view">
      ...
      <div class="descriptions-view">
        <div class="descriptions-item">
          ...
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">收货人姓名:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.takerName}}
            </div>
          </div>
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">收货人手机号:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.takerPhone}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">省份名称:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.provinceName}}
            </div>
          </div>
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">城市名称:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.cityName}}
            </div>
          </div>
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">区名称:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.districtName}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">邮编:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.postCode}}
            </div>
          </div>
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">地点经度:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.placeLongitude}}
            </div>
          </div>
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">地点纬度:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.placeLatitude}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">详细地址:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.addressDetailed}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">是否默认:</el-tag>
            </div>
            <div class="descriptions-value">
              {{handleTypeByValue(particularsData.defaultStatus,yesOrNoOptions)}}
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    setMapData() {
      ...
      console.log('dataMapView:'+document.getElementById('dataMapView'))
      //定义地图中心点坐标
      let center = new TMap.LatLng(this.position.latitude, this.position.longitude)
      //定义map变量，调用 TMap.Map() 构造函数创建地图
      map = new TMap.Map(document.getElementById('dataMapView'), {
    ...
    async init(data) {
      ...
      await this.showParticulars(data);
