<template>
  <div class="page-view">
      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          <div class="search-view">
            <div class="search-item-view">
              <el-form-item label="用户信息">
                <el-select
                    v-model="searchData.authAppUserId"
                    :clearable="true"
                    placeholder="请选择用户信息">
                  <el-option
          ...
          <div class="search-view">
            ...
            <div class="search-item-view">
              <el-form-item label="区名称">
                <el-input
                    v-model="searchData.districtName"
                    placeholder="区名称"
                ></el-input>
              </el-form-item>
            </div>
            ...
            <div class="search-item-view">
              <el-form-item label="地点经度">
                <el-input
                    v-model="searchData.placeLongitude"
                    placeholder="地点经度"
                ></el-input>
              </el-form-item>
            </div>
          ...
          <div class="search-view">
            <div class="search-item-view">
              <el-form-item label="地点纬度">
                <el-input
                    v-model="searchData.placeLatitude"
                    placeholder="地点纬度"
                ></el-input>
              </el-form-item>
            </div>
            <div class="search-item-view">
              <el-form-item label="详细地址">
                <el-input
                    v-model="searchData.addressDetailed"
                    placeholder="详细地址"
                ></el-input>
              </el-form-item>
            </div>
            <div class="search-item-view">
              <el-form-item label="是否默认">
                <el-select
                    v-model="searchData.defaultStatus"
                    :clearable="true"
                    placeholder="请选择是否默认">
                  <el-option
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('takeAddress:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('takeAddress:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('takeAddress:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
    ...
    >
      ...
      >
        <template v-slot="scope">
          <el-tag size="medium">{{handleTypeByValue(scope.row.authAppUserId,authAppUserOptions)}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="takerName"
      ...
      >
        <template v-slot="scope">
          <el-tag size="medium">{{handleTypeByValue(scope.row.defaultStatus,yesOrNoOptions)}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="operatorId"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('takeAddress:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('takeAddress:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('takeAddress:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleTakeAddressChange(value) {
        this.searchData.takeAddressId = value
      },
        ...
        try {
          Api.queryTakeAddress({}).then((res) => {
            if (res.success) {
              ...
              this.takeAddressOptions = new Array();
              data.map((item) => {
                let options = {
                  'text': item.takeAddressName,
                  'value': item.takeAddressId
                }
                this.takeAddressOptions.push(options)
              })
              console.log('this.takeAddressOptions:' + JSON.stringify(this.takeAddressOptions))
              loading.close();
            } else {
              loading.close();
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.takeAddressId)
