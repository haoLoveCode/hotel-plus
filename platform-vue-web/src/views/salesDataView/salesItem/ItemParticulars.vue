    ...
    <div class="particulars-view">
      ...
      <div class="descriptions-view">
        ...
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">发布人:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.publisherId}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">商品名称:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.itemName}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">商品简介:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.itemSummary}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">商品标题:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.itemTitle}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">销售价格:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.salePrice}}
            </div>
          </div>
        </div>
        <div class="descriptions-item">
        ...
        <div class="descriptions-item">
          <div class="descriptions-item-view">
            <div class="descriptions-title">
              <el-tag size="medium">商品状态:</el-tag>
            </div>
            <div class="descriptions-value">
              {{particularsData.itemStatus}}
            </div>
          </div>
        </div>
      </div>
