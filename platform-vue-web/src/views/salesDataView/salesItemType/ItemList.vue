<template>
  <div class="page-view">
      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('salesItemType:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('salesItemType:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('salesItemType:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
    ...
    >
      ...
      >
        <template v-slot="scope">
          <el-tag size="medium">{{handleTypeByValue(scope.row.dataStatus,yesOrNoOptions)}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="operatorId"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('salesItemType:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('salesItemType:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('salesItemType:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleSalesItemTypeChange(value) {
        this.searchData.salesItemTypeId = value
      },
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.salesItemTypeId)
        this.deleteButtonLoading = true
        Api.batchDeleteSalesItemType({
      ...
      batchDelete() {
        ...
        multipleSelection.map(item => {
          mainIdList.push(item.salesItemTypeId)
        })
