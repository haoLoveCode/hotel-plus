      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('roomCheckIn:add')">
              <el-form-item>
                <el-button
                    size="mini"
                    type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('roomCheckIn:export')">
              <el-form-item>
                <el-button
                    size="mini"
                    @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('roomCheckIn:batchDelete')">
              <el-form-item>
                <el-button
                    size="mini"
                    type="danger"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('roomCheckIn:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomCheckIn:edit') && false">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomCheckIn:deleteOne')">
              <el-button
...
export default {
  ...
  methods: {
    ...
    async handleRoomCheckInChange(value) {
      this.searchData.roomCheckInId = value
    },
    async queryRoomCheckIn() {
      const loading = this.$loading({
        lock: true,
        text: "正在请求。。。",
        spinner: 'el-icon-loading',
      ...
      try {
        Api.queryRoomCheckIn({}).then((res) => {
          if (res.success) {
            ...
            this.roomCheckInOptions = new Array();
            data.map((item) => {
              let options = {
                'text': item.roomCheckInName,
                'value': item.roomCheckInId
              }
              this.roomCheckInOptions.push(options)
            })
            console.log('this.roomCheckInOptions:' + JSON.stringify(this.roomCheckInOptions))
            loading.close();
          } else {
            loading.close();
            this.$message.error('服务器异常');
    ...
    deleteOne(data) {
      ...
      mainIdList.push(data.roomCheckInId)
      this.deleteButtonLoading = true
      Api.batchDeleteRoomCheckIn({
    ...
    batchDelete() {
      ...
      multipleSelection.map(item => {
        mainIdList.push(item.roomCheckInId)
      })
