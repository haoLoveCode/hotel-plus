<template>
  <div class="page-view">
      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          <div class="search-item-view">
            <el-form-item label="房间图片信息">
              <el-select
                  v-model="searchData.roomImgId"
                  :clearable="true"
                  @change="handleRoomImgChange"
                  placeholder="请选择房间图片信息">
                <el-option
                    v-for="(item,index) in roomImgOptions"
                    :key="item.value"
                    :label="item.text"
                    :value="item.value">
                </el-option>
          ...
          <div class="search-view">
            <div class="search-item-view">
              <el-form-item label="业务主键">
                <el-select
                    v-model="searchData.salesItemImgId"
                    :clearable="true"
                    placeholder="请选择-业务主键信息">
                  <el-option
                      v-for="(item,index) in salesItemImgOptions"
                      :key="item.value"
                      :label="item.text"
                      :value="item.value">
                  </el-option>
          ...
          <div class="search-view">
            <div class="search-item-view">
              <el-form-item label="访问地址">
                <el-input
                    v-model="searchData.imgUrl"
                    placeholder="请填写-访问地址"
                    maxlength="10"
                    show-word-limit>
                </el-input>
              </el-form-item>
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('roomImg:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('roomImg:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('roomImg:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
    ...
    >
      ...
      >
        <template v-slot="scope">
          <el-tag size="medium">{{handleTypeByValue(scope.row.salesItemImgId,salesItemImgOptions)}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
          prop="roomDataId"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('roomImg:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomImg:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomImg:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleRoomImgChange(value) {
        this.searchData.roomImgId = value
      },
      async queryRoomImg() {
        ...
        try {
          Api.queryRoomImg({}).then((res) => {
            if (res.success) {
              ...
              this.roomImgOptions = new Array();
              data.map((item) => {
                let options = {
                  'text': item.roomImgName,
                  'value': item.roomImgId
                }
                this.roomImgOptions.push(options)
              })
              console.log('this.roomImgOptions:' + JSON.stringify(this.roomImgOptions))
              loading.close();
            } else {
              loading.close();
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.roomImgId)
        this.deleteButtonLoading = true
        Api.batchDeleteRoomImg({
      ...
      batchDelete() {
        ...
        multipleSelection.map(item => {
          mainIdList.push(item.roomImgId)
        })
