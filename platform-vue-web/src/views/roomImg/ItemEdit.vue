      ...
      >
        <div class="data-body-div">
          <div class="data-item-view">
            <el-form-item label="业务主键" prop="salesItemImgId">
              <el-select
                  v-model="submitData.salesItemImgId"
                  :clearable="true"
        ...
        <div class="data-body-div">
          <div class="data-item-view">
            <el-form-item label="访问地址" prop="imgUrl">
              <el-input
                  v-model="submitData.imgUrl"
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs.submitForm.validate((valid) => {
        ...
        try {
          Api.editRoomImgItem(params).then((res) => {
            if (res.success) {
              this.editVisible = false;
