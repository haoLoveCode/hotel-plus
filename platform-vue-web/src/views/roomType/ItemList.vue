      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('roomType:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('roomType:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('roomType:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('roomType:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomType:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomType:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleRoomTypeChange(value) {
        this.searchData.roomTypeId = value
      },
      async queryRoomType() {
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.roomTypeId)
        this.deleteButtonLoading = true
        Api.batchDeleteRoomType({
      ...
      batchDelete() {
        ...
        multipleSelection.map(item => {
          mainIdList.push(item.roomTypeId)
        })
