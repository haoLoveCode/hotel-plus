  ...
  <el-dialog title="新增交易订单信息"
    ...
    <div class="add-body">
      ...
      >
        ...
        <div class="text-area-view">
          <div class="add-item-view" style="width: 100%">
...
import {orderStatusOptions, orderTypeOptions, payTypeOptions} from "../../utils/bizConstants";
export default {
  components: {
    UploadImg: UploadImg
  },
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs.submitForm.validate((valid) => {
        ...
        try {
          Api.addTradeOrderItem(params).then((res) => {
            if (res.success) {
              this.addVisible = false;
