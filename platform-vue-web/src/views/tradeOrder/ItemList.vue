<template>
  <div class="page-view">
    <div class="page-search-view">
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          <div class="search-view">
            ...
            <div class="search-item-view">
              <el-form-item label="订单备注">
                <el-input
                    v-model="searchData.orderRemark"
                    placeholder="订单备注"
                ></el-input>
              </el-form-item>
            </div>
          ...
          <div class="search-view">
            ...
            <div class="search-item-view">
              <el-form-item label="订单价格">
                <el-input
                    v-model="searchData.orderAmount"
                    placeholder="订单价格"
                ></el-input>
              </el-form-item>
            </div>
          ...
          <div class="search-view">
            <div class="search-item-view">
              <el-form-item label="订单额外数据">
                <el-input
                  v-model="searchData.extraData"
                  placeholder="订单额外数据"
                ></el-input>
              </el-form-item>
            </div>
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('tradeOrder:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('tradeOrder:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('tradeOrder:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
    ...
    >
      ...
      >
        <template v-slot="scope">
          {{handleTypeByValue(scope.row.orderType,orderTypeOptions)}}
        </template>
      </el-table-column>
      <el-table-column
        prop="orderRemark"
      ...
      >
        <template v-slot="scope">
          {{handleTypeByValue(scope.row.payType,payTypeOptions)}}
        </template>
      </el-table-column>
      <el-table-column
        prop="extraData"
      ...
      >
        <template v-slot="scope">
          {{handleTypeByValue(scope.row.orderStatus,orderStatusOptions)}}
        </template>
      </el-table-column>
      <el-table-column
        prop="operatorId"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('tradeOrder:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('tradeOrder:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('tradeOrder:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleTradeOrderChange(value) {
        this.searchData.tradeOrderId = value
      },
      async queryTradeOrder() {
        const loading = this.$loading({
          lock: true,
          text: "正在请求。。。",
          spinner: 'el-icon-loading',
        ...
        try {
          Api.queryTradeOrder({}).then((res) => {
            if (res.success) {
              ...
              this.tradeOrderOptions = new Array();
              data.map((item) => {
                let options = {
                  'text': item.tradeOrderName,
                  'value': item.tradeOrderId
                }
                this.tradeOrderOptions.push(options)
              })
              console.log('this.tradeOrderOptions:' + JSON.stringify(this.tradeOrderOptions))
              loading.close();
            } else {
              loading.close();
              this.$message.error('服务器异常');
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.tradeOrderId)
        this.deleteButtonLoading = true
        Api.batchDeleteTradeOrder({
      ...
      batchDelete() {
        ...
        multipleSelection.map(item => {
          mainIdList.push(item.tradeOrderId)
        })
