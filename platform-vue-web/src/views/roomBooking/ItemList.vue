<template>
  <div class="page-view">
      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          <div class="search-view">
            <div class="search-item-view">
              <el-form-item label="预定人">
                <el-select
                    v-model="searchData.subscriberId"
                    :clearable="true"
            ...
            <div class="search-item-view">
              <el-form-item label="预定状态">
                <el-select
                    v-model="searchData.bookingStatus"
                    :clearable="true"
          ...
          <div class="search-view">
            ...
            <div class="search-item-view">
              <el-form-item label="预订时间">
                <el-input
                    v-model="searchData.bookingTime"
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('roomBooking:add')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="primary"
            ...
            <div class="search-item-view" v-if="isAuth('roomBooking:export')">
              <el-form-item>
                <el-button
                  size="mini"
                  @click="handleExport"
            ...
            <div class="search-item-view" v-if="isAuth('roomBooking:batchDelete')">
              <el-form-item>
                <el-button
                  size="mini"
                  type="danger"
    ...
    >
      ...
      >
        <template v-slot="scope">
          <el-tag size="medium">{{handleTypeByValue(scope.row.bookingStatus,bookingStatusOptions)}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
          prop="bookingNo"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('roomBooking:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomBooking:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('roomBooking:deleteOne')">
              <el-button
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleRoomBookingChange(value) {
        this.searchData.roomBookingId = value
      },
      ...
      deleteOne(data) {
        ...
        mainIdList.push(data.roomBookingId)
        this.deleteButtonLoading = true
        Api.batchDeleteRoomBooking({
      ...
      batchDelete() {
        ...
        multipleSelection.map(item => {
          mainIdList.push(item.roomBookingId)
        })
