  ...
  <div class="page-view">
      ...
      <el-form :inline="true" ref="pageForm">
        <div class="search-param-view">
          ...
          <div class="search-view">
            ...
            <div class="search-item-view" v-if="isAuth('platformDict:add')">
              <el-form-item>
                <el-button
                    type="primary"
                    size="mini"
            ...
            <div class="search-item-view" v-if="isAuth('platformDict:batchDelete')">
              <el-form-item>
                <el-button
                    type="danger"
                    size="mini"
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          <div class="operation-view">
            <div class="operation-button-view" v-if="isAuth('platformDict:view')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('platformDict:edit')">
              <el-button
            ...
            <div class="operation-button-view" v-if="isAuth('platformDict:deleteOne')">
              <el-button
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="handleDeleteOne" :loading="deleteButtonLoading">确 定</el-button>
            </span>
    </el-dialog>
    <!--批量删除确认框-->
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    deleteOne(data) {
      ...
      mainIdList.push(data.platformDictId)
      this.deleteButtonLoading = true
      Api.batchDeletePlatformDict({
    ...
    batchDelete() {
      ...
      multipleSelection.map(item => {
        mainIdList.push(item.platformDictId)
      })
