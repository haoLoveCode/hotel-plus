...
export default {
  ...
  methods: {
    ...
    deleteOne(data) {
      ...
      mainIdList.push(data.platformApiLogId)
      this.deleteButtonLoading = true
      Api.batchDeletePlatformApiLog({
    ...
    batchDelete() {
      ...
      multipleSelection.map(item => {
        mainIdList.push(item.platformApiLogId)
      })
