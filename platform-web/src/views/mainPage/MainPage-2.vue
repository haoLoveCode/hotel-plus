<template>
  <div class="page-view">
    <el-carousel indicator-position="outside" class="swiper-view" type="card" height="300px">
    ...
    <el-divider content-position="center">数据列表</el-divider>
    ...
    <el-divider content-position="center" v-if="dataList.length > 0">系统公告</el-divider>
    <div class="data-set-view" v-if="dataList.length > 0">
