...
export default {
  ...
  methods: {
    ...
    setMapData() {
      ...
      map = new TMap.Map(document.getElementById('addDataMap'), {
    ...
    async setOtherData(data) {
      ...
      this.submitData.authAppUserId = userData.authAppUserId;
    ...
    handleSubmit() {
      this.$refs.submitForm.validate((valid) => {
        ...
        try {
          Api.addTakeAddressItem(params).then(async (res) => {
            if (res.success) {
